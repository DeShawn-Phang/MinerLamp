...
def train_loop(
    ...
    for epoch in range(1, max_epochs + 1):
        ...
        # Save if good enough.
        if valid_metric < best_valid_metric or (valid_metric==best_valid_metric and train_metric < best_train_metric):
            log_fun(
            ...
            best_train_metric = train_metric # modified
